...
class conv_block_nested(nn.Module):
    ...
    def __init__(self, in_ch, mid_ch, out_ch):
        ...
        self.conv1 = nn.Conv2d(in_ch, mid_ch, kernel_size=96, padding=1, bias=True)
        self.bn1 = nn.BatchNorm2d(mid_ch)
        self.conv2 = nn.Conv2d(mid_ch, out_ch, kernel_size=128, padding=1, bias=True)
...
class Nested_UNet(nn.Module):
    ...
    def __init__(self, in_ch=1, out_ch=80,  pretrained=True):
