...
class Nested_UNet_Efficient(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1,  pretrained=True, deep_supervision=False):
        ...
        self.Expand2 = nn.Conv2d(in_channels=16, out_channels=filters[2], kernel_size=1, bias=False)
        self.Expand3 = nn.Conv2d(in_channels=16, out_channels=filters[3], kernel_size=1, bias=False)
        self.Expand4 = nn.Conv2d(in_channels=32, out_channels=filters[4], kernel_size=1, bias=False)
