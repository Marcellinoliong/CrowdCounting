...
class Nested_UNet_Densenet5(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1,  pretrained=True, deep_supervision=False):
        ...
        self.trans1 = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=1, bias=False)
        self.trans2 = nn.Conv2d(in_channels=32, out_channels=16, kernel_size=1, bias=False)
        self.trans3 = nn.Conv2d(in_channels=16, out_channels=8, kernel_size=1, bias=False)
        self.trans4 = nn.Conv2d(in_channels=8, out_channels=4, kernel_size=1, bias=False)
        self.trans5 = nn.Conv2d(in_channels=4, out_channels=2, kernel_size=1, bias=False)
    ...
    def forward(self, x):
        ...
        x2_0 = self.trans2(F.interpolate(x_dn, scale_factor=8, mode='bilinear', align_corners=True))
        #print(x2_0.size())
        ...
        x3_0 = self.trans3(F.interpolate(x_dn, scale_factor=4, mode='bilinear', align_corners=True))
        #print(x3_0.size())
        ...
        x4_0 = self.trans4(F.interpolate(x_dn, scale_factor=2, mode='bilinear', align_corners=True))
        #print(x4_0.size())
