...
#------------Prepare Trainer------------
net = cfg.NET
if net in ['MCNN', 'AlexNet', 'VGG', 'VGG_DECODER', 'Res50', 'Res101', 'CSRNet','Res101_SFCN', 'UNet++', 'UNet', 'UNet3P', 'MnasNet', 'UNet2D', 'BiSeNet', 'Basenet', 'ERFNet', 'EDANet', 'ENet', 'ESPNet', 'mobilenet']:
