...
__C_SHHA.TRAIN_SIZE = (192,256) # 2D tuple or 1D scalar
__C_SHHA.DATA_PATH = '/home/marcellino/CrowdCounting/datasets/ProcessedData/shanghaitech_part_A'               
...
__C_SHHA.TRAIN_BATCH_SIZE = 3 #imgs
